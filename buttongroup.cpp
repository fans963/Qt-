...
void ButtonGroup::initButtons()
{
    ...
    connect(ui->start, &ElaToolButton::clicked, this, &ButtonGroup::startGame);
    connect(ui->playCard, &ElaToolButton::clicked, this, &ButtonGroup::playHand);
    connect(ui->playCard1, &ElaToolButton::clicked, this, &ButtonGroup::playHand);
    connect(ui->pass, &ElaToolButton::clicked, this, &ButtonGroup::pass);
    connect(ui->giveup, &ElaToolButton::clicked, this, [=]()
            {
                emit betPoint(0);
            });
    connect(ui->oneScore, &ElaToolButton::clicked, this, [=]()
            {
                emit betPoint(1);
            });
    connect(ui->twoScore, &ElaToolButton::clicked, this, [=]()
            {
                emit betPoint(2);
            });
    connect(ui->threeScore, &ElaToolButton::clicked, this, [=]()
            {
                emit betPoint(3);
            });
}
